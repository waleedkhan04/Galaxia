    ...
    <h1>GALAXIA</h1>
        <div class="container" >
            <div class="loginform" id="loginform">
                ...
                <asp:Button ID="Button2" runat="server" Text="LOGIN" CssClass="submitbutton" OnClick="logincheck"/>
                <div style="font: lighter 18px Gilroy;color: white;text-align: center;margin-top: 20px;"> Don't have an account? <a href="Signup.aspx" onclick="showSignup()" style="color:white;font-weight:bold">Signup</a></div>
            </div>
        </div>
        </form>
    </body>
